            ...
            <nav className="bg-white border-b border-gray-200">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                    <div className="flex items-center space-x-2 text-sm text-gray-500">
                        ...
                        <ChevronRight className="h-4 w-4" />
                        <span className="text-gray-900 font-medium">Peanuts</span>
                    </div>
                </div>
            </nav>
                    ...
                    <div className="flex items-center mb-6">
                        ...
                        <div>
                            <h1 className="text-4xl md:text-5xl font-bold mb-4">
                                {peanutSubCategory.name}
                            </h1>
                            <p className="text-xl text-gray-100 max-w-3xl">
                                {peanutSubCategory.description}
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {peanutSubCategory.products.map((product) => (
                            <div key={product.id} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                                <div className="p-6">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="text-sm text-gray-500">
                                            ...
                                            <ul className="list-disc list-inside mt-2">
                                                {product.packagingOptions.slice(0, 3).map((option, index) => (
                                    ...
                                    <Link
                                        to={`/products/oil-seeds/peanut/${product.slug}`}
            ...
            <section className="py-16 bg-gradient-to-r from-[#2B58A0] to-[#1e3f70] text-white">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h2 className="text-3xl md:text-4xl font-bold mb-6">
                        Premium Quality Peanuts for Your Business
                    </h2>
                    <p className="text-xl mb-8 text-gray-100">
                        Get competitive pricing for bulk orders and explore our complete peanut portfolio
                    </p>
