...
import { Menu, X, ChevronDown, Linkedin, Instagram, Twitter, Facebook, ChevronRight, Mail, Phone, MapPin } from 'lucide-react';
                ...
                item.hasDropdown ? (
                  ...
                  >
                    ...
                    {productsDropdownOpen && (
                      <div className={`absolute top-full left-0 mt-2 w-64 bg-white rounded-lg shadow-xl border border-gray-200 py-2 z-50 ${dropdownAnimating ? 'dropdown-enter' : 'dropdown-exit'}`}>
      ...
      <footer className="bg-[#2B58A0] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              <h4 className="text-2xl font-bold mb-6">Products</h4>
              <ul className="space-y-3">
                {productCategories.map((category) => (
            ...
            <div>
              ...
              <ul className="space-y-3 text-base text-gray-200">
                ...
                <li className="flex items-start">
                  ...
                  <span>A-216, Royal Plaza, Bapasitaram Chowk, BTRS Road, Simada Gam, Surat - 395006</span>
                </li>
              </ul>
            </div>
        ...
        <div className="bg-[#FF6F4E] py-4">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <p className="text-xl font-semibold text-white">&copy; 2025 Aventora International. All rights reserved.</p>
          </div>
        </div>
      </footer>
